...
com o plano completo (60 semanas) encerrando em 26/Set/2027 — semana 60 —
e a prova prevista para ocorrer durante a Fase 3 (agosto–setembro/2027).

O QUE ESTE SCRIPT FAZ:
1. Desloca as datas das Semanas 1 a 50 em +84 dias (12 semanas) a partir do
   arquivo original (início 11/Mai/2026) — Fase 1 (semanas 1-26) e o corpo
   principal da Fase 2 (semanas 27-50) ficam com o MESMO conteúdo,
   apenas em datas posteriores.
...
3. Insere as Semanas 53-60 (Fase 3 completa — Revisão e simulados).
4. Atualiza os textos globais fixos (barra lateral "Início" e frase de
   abertura do dashboard).
5. Atualiza o array PHASES (períodos e cargas horárias de F1/F2/F3).
...
SHIFT = dt.timedelta(days=84)

FASE3_BLOCK = """['w53',3,53,'Revisão sistemática final — Manobrabilidade e Arte Naval','02–08/Ago/2027 · Semana 53','Manobrabilidade + Arte Naval',33,
...
['w54',3,54,'Revisão sistemática final — Navegação, Meteorologia, Comunicações e CG','09–15/Ago/2027 · Semana 54','Navegação + Meteorologia + Comunicações + CG',33,
...
['w55',3,55,'Revisão sistemática final — Legislação e tópicos finais do CP','16–22/Ago/2027 · Semana 55','Legislação + Direito Processual + Economia Marítima',33,
...
['w56',3,56,'Prova real completa cronometrada nº 1 — PSCPP/2011','23–29/Ago/2027 · Semana 56','Simulado real cronometrado',33,
...
['w57',3,57,'Prova real completa cronometrada nº 2 — PSCPP/2012 (Prova Rosa)','30/Ago–05/Set/2027 · Semana 57','Simulado real cronometrado',33,
...
['w58',3,58,'Prova real completa cronometrada nº 3 — PSCPP/2008 + reforço geral','06–12/Set/2027 · Semana 58','Simulado real cronometrado',33,
...
['w59',3,59,'Reforço cirúrgico final e simulado geral integrado','13–19/Set/2027 · Semana 59','Todas as disciplinas',35,
...
['w60',3,60,'Semana de desaceleração e preparação para a prova','20–26/Set/2027 · Semana 60','Desaceleração e logística',18,
...
CONDENSED_BLOCK = """['w51',2,51,'Diagnóstico final e reforço dirigido — Fase 2','19–25/Jul/2027 · Semana 51','Todas as disciplinas',33,
...
['w52',2,52,'Revisão integrada final e fechamento da Fase 2','26/Jul–01/Ago/2027 · Semana 52','Todas as disciplinas',35,
...
def main(path):
    ...
    print(f"Datas deslocadas em +84 dias para {count} semanas (esperado: 50).")
    if count != 50:
    ...
    content = content.replace(
        ...
        "{id:1,label:'F1',title:'Fundamentos e imersão',period:'03 Ago 2026 – 31 Jan 2027',hours:'~650h'"
    )
    content = content.replace(
        "{id:2,label:'F2',title:'Aprofundamento técnico',period:'Nov 2026 – Mai 2027',hours:'~980h'",
        "{id:2,label:'F2',title:'Aprofundamento técnico',period:'01 Fev – 01 Ago 2027',hours:'~890h'"
    )
    content = content.replace(
        "{id:3,label:'F3',title:'Revisão e simulados',period:'Jun – Set 2027',hours:'~650h'",
        "{id:3,label:'F3',title:'Revisão e simulados',period:'02 Ago – 26 Set 2027 (8 semanas)',hours:'~250h'"
    )
